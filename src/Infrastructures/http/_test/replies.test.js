...
describe('/replies endpoint', () => {
  ...
  describe('when POST /threads/{threadId}/comments/{commentId}/replies', () => {
    ...
    it('should response 400 if request payload not contain required property', async () => {
      ...
      expect(responseJson.message).toEqual('cannot create a new reply because the required properties are missing');
    });
    ...
    it('should response 400 if request payload not meet data type specification', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('cannot create a new reply because the data type does not meet data type specification');
    });
